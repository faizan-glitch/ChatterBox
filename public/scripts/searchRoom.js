...
searchButton.addEventListener('click', () => {
  ...
  .then(async res => {
    res = await res.json();
    if(res) {
      $('#searchList').html(`<li class="list-group-item text-left"> <a class="nav-link" id="v-pills-home-tab" data-toggle="pill" role="tab" href='#${res.name}'
    ...
    $('#collapseSearch').collapse();  //! this is not working!!!!
  })
  .catch(err => {
    console.log(err);       
  })
